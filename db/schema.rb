...
ActiveRecord::Schema.define(version: 2025_12_08_125242) do
  ...
  create_table "active_list_allergy", primary_key: "active_list_id", id: :integer, charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "active_list_problem", primary_key: "active_list_id", id: :integer, charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.string "status", limit: 50
    t.float "sort_weight", limit: 53
  end

  create_table "active_list_type", primary_key: "active_list_type_id", id: :integer, charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "concept_complex", primary_key: "concept_id", id: :integer, default: nil, charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.string "handler"
  end
  ...
  create_table "liquibasechangeloglock", primary_key: "ID", id: :integer, default: nil, charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
  ...
  create_table "location_tag", primary_key: "location_tag_id", id: :integer, charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.string "name", limit: 50
    t.string "description"
    t.integer "creator", null: false
    t.datetime "date_created", null: false
  ...
  create_table "location_tag_map", primary_key: ["location_id", "location_tag_id"], charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.integer "location_id", null: false
  ...
  create_table "pharmacy_encounter_type", primary_key: "pharmacy_encounter_type_id", id: :integer, charset: "latin1", collation: "latin1_swedish_ci", options: "ENGINE=MyISAM", force: :cascade do |t|
    t.string "name", limit: 50, null: false
    t.text "description", null: false
    t.string "format", limit: 50
    t.integer "foreign_key"
  ...
  create_table "schema_info", id: false, charset: "latin1", collation: "latin1_swedish_ci", options: "ENGINE=MyISAM", force: :cascade do |t|
    t.integer "version"
  end

  create_table "serialized_object", primary_key: "serialized_object_id", id: :integer, charset: "latin1", collation: "latin1_swedish_ci", force: :cascade do |t|
    t.string "name", null: false
  ...
  create_table "weight_for_heights", id: false, charset: "latin1", collation: "latin1_swedish_ci", options: "ENGINE=MyISAM", force: :cascade do |t|
    t.float "supinecm", limit: 53, null: false
    t.float "median_weight_height", limit: 53, null: false
  end

  create_table "weight_height_for_age", id: false, charset: "latin1", collation: "latin1_swedish_ci", options: "ENGINE=MyISAM", force: :cascade do |t|
  ...
  create_table "weight_height_for_ages", id: false, charset: "latin1", collation: "latin1_swedish_ci", options: "ENGINE=MyISAM", force: :cascade do |t|
